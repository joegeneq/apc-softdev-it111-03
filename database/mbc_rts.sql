...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 30, 2015 at 12:51 PM
...
CREATE TABLE IF NOT EXISTS `prayer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `prayerrequest_code` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
--
-- Table structure for table `user_gives_prayer`
--

CREATE TABLE IF NOT EXISTS `user_gives_prayer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `prayerrequest_id` int(11) NOT NULL,
  `member_gives_prayerrequest_description` varchar(100) DEFAULT NULL,
...
--
-- Constraints for table `user_gives_prayer`
--
ALTER TABLE `user_gives_prayer`
  ADD CONSTRAINT `fk_Member_gives_PrayerRequest_PrayerRequest1` FOREIGN KEY (`prayerrequest_id`) REFERENCES `prayer` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
